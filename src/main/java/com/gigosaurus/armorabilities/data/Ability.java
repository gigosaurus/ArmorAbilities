 ...
 */
public enum Ability {
    SPEED(false, "lets you run faster with each piece of Speed Armor. "
            + "You will also dig faster with a full suit of Speed Armor equipped."),
    MOON(false, "lets you jump higher with each piece of Moon Armor. "
                 + "You will also take no fall damage with a full suit of Moon Armor equipped."),
    SCUBA(false, "lets you breathe underwater longer with each piece of Scuba Armor. "
            + "You will also dig faster underwater with a full suit of Scuba Armor equipped."),
    LAVA(false, "lets you swim in lava longer with each piece of Lava Armor. "
            + "You will also take no fire damage with a full suit of Lava Armor equipped."),
    ...
    ASSASSIN(true, "is activated when a full suit of Assassin Armor is equipped. "
            + "When sneaking, it makes you invisible to other players and increases your damage."),
    ...
    private final boolean requireFour;
    private final String name;
    private final String description;

    Ability(boolean requireFour, String description) {
        this.requireFour = requireFour;
